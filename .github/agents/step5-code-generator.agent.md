...
4. Link generated operations and TODOs to requirement IDs. Leave explicit TODOs
   for unspecified business behavior; do not return fabricated success data.
5. Write `analysis-reports/code-generation-log.json` and update shared context.
...
business logic. Stop after reporting artifacts, build result, gaps, and Step 6
eligibility.
